...
const Leaderboard = () => {
  ...
  useEffect(() => {
    const getLeaderboardData = async () => {
      ...
      const options = {
        ...
        headers: {
          Authorization:
            "Bearer yeyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InJhaHVsIiwicm9sZSI6IlBSSU1FX1VTRVIiLCJpYXQiOjE2MjMwNjU1MzJ9.D13s5wN3Oh59aa_qtXMo3Ec4wojOx0EZh8Xr5C5sRkU",
        },
      };
  ...
  const renderFailureView = () => {
    ...
    console.log(errorMsg, apiResponse.status);
